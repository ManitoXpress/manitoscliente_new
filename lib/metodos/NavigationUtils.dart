...
class NavigationUtils {
  static void openServiceFormPage(BuildContext context, Map<String, dynamic> map, String buttonText) async {
    // Obtiene el token
    ...
    if (token != null) {
      ...
      ServiceType serviceType = ServiceType(id: serviceTypeId, name: serviceTypeName, selectedDate: '', selectedTime: '');

      DateTime? selectedDate = map['selectedDate'] != null ? DateTime.parse(map['selectedDate']) : null;
